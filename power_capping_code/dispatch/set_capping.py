...
def capping()
	...
	# i = 0
	# while(icpu_num)
	# 	su1 = set_power_limit(i, [pkg_limit_1], int(max_powercapping_proportion1000000))
	# 	su2 = set_time_window(i, [pkg_limit_1], 3000000)
	# 	su3 = set_power_limit(i, [pkg_limit_2], int(max_powercapping_proportion1000000))
...
def uncapping()
	...
	# i = 0
	# while(icpu_num)
	# 	su1 = set_power_limit(i, [pkg_limit_1], int(max_power1000000))
	# 	su2 = set_time_window(i, [pkg_limit_1], 3000000)
	# 	su3 = set_power_limit(i, [pkg_limit_2], int(max_power1000000))
	# 	su4 = set_time_window(i, [pkg_limit_2], 3000000)
	# 	if su1 == 0  su2 == 0  su3 == 0  su4 == 0
	# 		print(uncapping操作失败！)
	# 	else
